...
/* ─────────────────────────────────────────────
   WhatsApp Widget Component (mantiene igual)
───────────────────────────────────────────── */
...
function MobileMenu({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      {/* Menu Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-64 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-out ${
          ...
          {menuItems.map((item) => (
            <button
              ...
              className={`text-left px-4 py-2.5 rounded-md font-semibold transition-all ${
                item.primary
                  ? item.isContact
                    ? "text-white" + (item.name === "INICIO" ? " bg-red-500" : " bg-gray-400")
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Productos */}
      <section id="productos" className="py-20" style={{ background: "linear-gradient(140deg, #fffbf9cd 10%, #9c9898 50%, #b91c1c 100%)" }}>
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">Nuestros Productos</h2>
            <p className="text-lg text-gray-200 mt-2">Soluciones de alta calidad para la industria</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <div className="relative h-48 overflow-hidden">
                <img 
                  src="/g1.jpg" 
                  alt="Medidor de Consistencia" 
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-3 left-3">
                  <span className="bg-red-500 text-white text-xs font-bold px-3 py-1 rounded-full">Destacado</span>
                </div>
              </div>
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-red-500 hover:text-red-600 font-semibold text-sm inline-flex items-center gap-1">
                    Ver más <span>→</span>
                  </a>
                </div>
              </div>
            ...
            <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-3 right-3">
                  <span className="bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded-full"></span>
                </div>
              </div>
              <div className="p-5">
                <h3 className="text-lg font-bold text-gray-800 mb-2"></h3>
          ...
          <div className="text-center mt-12">
            <a 
              ...
              className="inline-flex items-center gap-2 bg-white text-red-600 px-8 py-3 rounded-full font-semibold hover:bg-red-600 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl"
            >
