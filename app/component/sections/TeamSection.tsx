...
const TEAM_MEMBERS: TeamMember[] = [
  { name: "José Sepúlveda", role: "Gerente Técnico – Ingeniero Electrónico", avatarSrc: "/franciscoCar.jpeg" },
  { name: "Ignacio Chacón", role: "Gerente Desarrollo-Ingeniero Agrónomo", avatarSrc: "/ignacio.jpg" },
  { name: "Francisco Carreño", role: "Ingeniero Especialista – Ingeniero Mecatrónico", avatarSrc: "/joseSe.jpeg" },
  { name: "Ricardo Chacón", role: "Asesor Desarrollo – PhD Economics of Education", avatarSrc: "/BaselinePerson.png" },
];
                ...
                >
                  <div className="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-lg transition-shadow">
                    <div className="w-28 h-28 mx-auto mb-4 rounded-full overflow-hidden border-4 border-gray-100 shadow">
                      <img
                        src={member.avatarSrc ?? "/BaselinePerson.png"}
                        alt={member.name}
